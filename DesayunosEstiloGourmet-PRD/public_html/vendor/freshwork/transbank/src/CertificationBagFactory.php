...
class CertificationBagFactory
{
    ...
    public static function integrationWebpayNormal()
    {
        ...
        $private_key = dirname(__FILE__) . '/certs/webpay-plus-integration/597034530068.key';
        $client_certificate = dirname(__FILE__) . '/certs/webpay-plus-integration/597034530068.crt';

        return new CertificationBag($private_key, $client_certificate, null, CertificationBag::PRODUCTION);
    }
    ...
    public static function create(
        ...
        $environment = CertificationBag::PRODUCTION
    ) {
