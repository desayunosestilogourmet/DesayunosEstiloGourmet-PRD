                      ...
                      <table class="table table-striped mb-0 text-center" width="100%" id="dataTable" cellspacing="0">
                        ...
                        <tbody>
                          ...
                          <?php } ?>
                              ...
                              <?php if($row['idC'] == 1){?>
                                <td><a href="#" class="card-post__category badge badge-pill badge-primary"><?php echo $row['nombreC']; ?></a></td>
                              <?php }elseif($row['idC'] == 2){ ?>
                                <td><a href="#" class="card-post__category badge badge-pill badge-secondary"><?php echo $row['nombreC']; ?></a></td>
                              <?php }elseif($row['idC'] == 3){ ?>
                                <td><a href="#" class="card-post__category badge badge-pill badge-success"><?php echo $row['nombreC']; ?></a></td>
                              <?php }elseif($row['idC'] == 4){ ?>
                                <td><a href="#" class="card-post__category badge badge-pill badge-danger"><?php echo $row['nombreC']; ?></a></td>
                              <?php }elseif($row['idC'] == 5){ ?>
                                <td><a href="#" class="card-post__category badge badge-pill badge-warning"><?php echo $row['nombreC']; ?></a></td>
                              <?php }elseif($row['idC'] == 6){ ?>
                                <td><a href="#" class="card-post__category badge badge-pill badge-info"><?php echo $row['nombreC']; ?></a></td>
                              <?php }elseif($row['idC'] == 7){ ?>
                                <td><a href="#" class="card-post__category badge badge-pill badge-violet"><?php echo $row['nombreC']; ?></a></td>
                              <?php }elseif($row['idC'] == 8){ ?>
                                <td><a href="#" class="card-post__category badge badge-pill badge-dark"><?php echo $row['nombreC']; ?></a></td>
                              <?php }elseif($row['idC'] == 9){ ?>
                                <td><a href="#" class="card-post__category badge badge-pill badge-orange"><?php echo $row['nombreC']; ?></a></td>
                              <?php } ?>
