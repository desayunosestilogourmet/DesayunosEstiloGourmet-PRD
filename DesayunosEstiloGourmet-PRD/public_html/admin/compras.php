                        ...
                        <tbody>
                          <?php while($row = mysqli_fetch_array($listaComercio)){ $comuna = obtieneComunaPorID($row['id_comuna_delivery']); ?>
                            <tr>
                              ...
                              <?php 
                                $detalles =  detalle_compra($row['orden_compra']);
                               
                                while ($row_detalle =  mysqli_fetch_array($detalles)) {
                                    
                                    $detalle_final =  '<b>Producto: </b>'.$row_detalle["nombre"].' - '.'<b>Cantidad: </b>'.$row_detalle["cantidad_producto"].'<br>';
                                }
                              ?>
                              <td><a href="#" onclick='modal("<?php echo name($detalle_final)?>", "Mensaje")'>Ver</a></td>
                            </tr>
                          <?php } ?>
                        </tbody>
                      </table>
