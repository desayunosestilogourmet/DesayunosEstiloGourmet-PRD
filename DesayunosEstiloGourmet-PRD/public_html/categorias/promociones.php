...
$cant_prod =  obtenerCantidadPromociones();
...
<head>
    ...
    <!-- Title  -->
    <title>Promociones - Desayunos estilo gourmet</title>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="products-catagories-area clearfix">
                <div class="mt-3 ml-20">
                    <h2 class="titulo-cursivo">Categorias/ Promoción</h2>
                    <p>Estás indeciso o indecisa aun en cuanto a qué llevar, revisa estas promos</p>
                </div>
                <div class="dropdown centrado-filtro">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="1" data-location="promociones.php" data-pagina="<?php echo $pagina; ?>">Nombre A-Z</a>
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="2" data-location="promociones.php" data-pagina="<?php echo $pagina; ?>">Nombre Z-A</a>
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="3" data-location="promociones.php" data-pagina="<?php echo $pagina; ?>">Precio de menor a mayor</a>
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="4" data-location="promociones.php" data-pagina="<?php echo $pagina; ?>">Precio de mayor a menor</a>
                        </div>
                </div>
            ...
            if($cant_prod > 0) {
                ...
                if(isset($_SESSION["filtro"])){
                    if($_SESSION["filtro"] == 1){
                        $resp  = listarProductosPromociones($start, "ASC", "nombre");
                    }else if($_SESSION["filtro"] == 2){
                        $resp  = listarProductosPromociones($start, "DESC", "nombre");
                    }else if($_SESSION["filtro"] == 3){
                        $resp  = listarProductosPromociones($start, "ASC", "precio");
                    }else if($_SESSION["filtro"] == 4){
                        $resp  = listarProductosPromociones($start, "DESC", "precio");
                    }
                }else{
                    $resp  = listarProductosPromociones($start, "ASC", "nombre");
                }
     ...
     <?php 
                        ...
                        echo '<nav aria-label="navigation" class="mr-18">';
                            ...
                            if ($total_pages > 1) {
                                ...
                                if ($page != 1) {
                                    echo '<li class="page-item"><a class="page-link" href="promociones.php?page='.($page-1).'"><span aria-hidden="true">&laquo;</span></a></li>';
                                }
                                ...
                                for ($i=$inicio; $i<= $final ;$i++) {
                                    ...
                                    if($page == $i) {
                                        ...
                                        echo '<li class="page-item"><a class="page-link" href="promociones.php?page='.$i.'">'.$i.'</a></li>';
                                    }
                                }

                                if ($page != $total_pages) {
                                    echo '<li class="page-item"><a class="page-link" href="promociones.php?page='.($page+1).'"><span aria-hidden="true">&raquo;</span></a></li>';
                                }
                            }else{
