...
$cant_prod =  obtenerCantidadArmaTuPedido();
        ...
        <div class="products-catagories-area clearfix">
                ...
                <div class="dropdown centrado-filtro">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="1" data-location="armar-pedido.php" data-pagina="<?php echo $pagina; ?>">Nombre A-Z</a>
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="2" data-location="armar-pedido.php" data-pagina="<?php echo $pagina; ?>">Nombre Z-A</a>
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="3" data-location="armar-pedido.php" data-pagina="<?php echo $pagina; ?>">Precio de menor a mayor</a>
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="4" data-location="armar-pedido.php" data-pagina="<?php echo $pagina; ?>">Precio de mayor a menor</a>
                        </div>
                </div>
            ...
            if(isset($_SESSION["filtro"])){
                if($_SESSION["filtro"] == 1){
                    $resp  = listarProductosArmaTuPedido($start, "ASC", "nombre");
                }else if($_SESSION["filtro"] == 2){
                    $resp  = listarProductosArmaTuPedido($start, "DESC", "nombre");
                }else if($_SESSION["filtro"] == 3){
                    $resp  = listarProductosArmaTuPedido($start, "ASC", "precio");
                }else if($_SESSION["filtro"] == 4){
                    $resp  = listarProductosArmaTuPedido($start, "DESC", "precio");
                }
            }else{
                $resp  = listarProductosArmaTuPedido($start, "ASC", "nombre");
            }
      ...
      <?php 
                        ...
                        echo '<nav aria-label="navigation" class="mr-18">';
                            ...
                            if ($total_pages > 1) {
                                ...
                                if ($page != 1) {
                                    echo '<li class="page-item"><a class="page-link" href="armar-pedido.php?page='.($page-1).'"><span aria-hidden="true">&laquo;</span></a></li>';
                                }
                                ...
                                for ($i=$inicio; $i<= $final ;$i++) {
                                    ...
                                    if($page == $i) {
                                        ...
                                        echo '<li class="page-item"><a class="page-link" href="armar-pedido.php?page='.$i.'">'.$i.'</a></li>';
                                    }
                                }

                                if ($page != $total_pages) {
                                    echo '<li class="page-item"><a class="page-link" href="armar-pedido.php?page='.($page+1).'"><span aria-hidden="true">&raquo;</span></a></li>';
                                }
                            }else{
