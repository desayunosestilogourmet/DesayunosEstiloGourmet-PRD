...
<head>
    ...
    <!-- Title  -->
    <title>Día de la madre - Desayunos estilo gourmet</title>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="products-catagories-area clearfix">
                <div class="mt-3 ml-20">
                    <h2 class="titulo-cursivo">Categorias/ Día de la Madre</h2>
                ...
                <div class="dropdown centrado-filtro">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="1" data-location="dia-madre.php" data-pagina="<?php echo $pagina; ?>">Nombre A-Z</a>
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="2" data-location="dia-madre.php" data-pagina="<?php echo $pagina; ?>">Nombre Z-A</a>
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="3" data-location="dia-madre.php" data-pagina="<?php echo $pagina; ?>">Precio de menor a mayor</a>
                            <a onclick="filtro(this)" class="dropdown-item" href="#" data-value="4" data-location="dia-madre.php" data-pagina="<?php echo $pagina; ?>">Precio de mayor a menor</a>
                        </div>
                </div>
            ...
            if($cant_prod > 0) {
                ...
                if(isset($_SESSION["filtro"])){
                    if($_SESSION["filtro"] == 1){
                        $resp  = listarProductosDiaMadre($start, "ASC", "nombre");
                    }else if($_SESSION["filtro"] == 2){
                        $resp  = listarProductosDiaMadre($start, "DESC", "nombre");
                    }else if($_SESSION["filtro"] == 3){
                        $resp  = listarProductosDiaMadre($start, "ASC", "precio");
                    }else if($_SESSION["filtro"] == 4){
                        $resp  = listarProductosDiaMadre($start, "DESC", "precio");
                    }
                }else{
                    $resp  = listarProductosDiaMadre($start, "ASC", "nombre");
                }
                    ...
                    <div class="single-products-catagory clearfix">
                            <div class="col-sm-4 py-2">
                                    <div class="card mt-25 centrado-card" style="width: 18rem;">
                                            <img class="card-img-top" src="../img/productos/<?php echo $row["imagen"];?>" alt="Producto estilo gourmet">
                                            <div class="card-body">
